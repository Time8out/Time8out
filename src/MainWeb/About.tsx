...
const PILLARS = [
  {
    ...
    points: [
      ...
      "Overtime detection",
      "Manager dashboard with live view",
    ],
  },
  {
    icon: "🏋️",
...
const STATS = [
  { value: "3", label: "Verticals being built", suffix: "" },
  ...
  return (
    <>
      <style>{`
        ...
        /* ── 1. ORIGIN BAND ── full-width dark stripe */
        .about-origin {
        ...
        .about-origin-noise {
          ...
          background-size: 200px 200px; opacity: 0.35; pointer-events: none;
        }
        .about-origin-glow {
        ...
        .about-origin-headline em {
          font-style: normal;
          background: var(--gradient-brand);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
        }
        .about-origin-body {
          font-size: var(--font-size-md); line-height: 1.75;
        ...
        .about-creator-avatar {
          ...
          box-shadow: 0 0 0 3px rgba(233,82,14,0.3);
        }
        .about-creator-name {
        ...
        .about-creator-location {
          ...
          font-size: var(--font-size-xs); color: var(--brand-orange);
        ...
        /* ── 2. PROBLEM STRIP ── */
        .about-problem {
          background: var(--color-bg); padding: var(--space-16) var(--space-6);
          position: relative;
        }
        ...
        .about-problem-arrow {
          ...
          color: var(--brand-orange); font-size: 14px; margin-top: auto;
        }

        /* ── 3. SOLUTION PILLARS ── */
        .about-solution {
          background: var(--color-white); padding: var(--space-20) var(--space-6);
        }
        ...
        .about-solution-title {
          ...
          letter-spacing: -0.025em; line-height: 1.15; color: var(--color-text);
        ...
        .about-pillar {
          border-radius: var(--radius-xl); border: 1.5px solid;
        ...
        .about-stat-val {
          font-family: 'Syne', sans-serif; font-size: var(--font-size-3xl);
      ...
      <section className="about" id="about">
        ...
        {/* ══════════════════════════════════════════════
            1. ORIGIN — dark band with creator card
        ══════════════════════════════════════════════ */}
          ...
          <div className="about-origin-inner">
            ...
            <div className="about-origin-copy">
              ...
              <p className="about-origin-body">
                Walking through <strong>small business district</strong> — ESL schools,
                gyms, BPO teams, small offices — the same scene kept repeating:
            ...
            <div className="about-creator">
              <div className="about-creator-top">
                ...
                <div>
                  ...
                  <div className="about-creator-location" style={{ marginTop: "6px" }}>
                    📍 Philippines
                  </div>
                </div>
              </div>
              <blockquote className="about-creator-quote">
                "I saw ESL teachers tracking class hours in group chats. Gym owners using
                paper sign-in sheets. Small business owners spending their Sunday nights
                reconciling attendance on Excel.<br /><br />
        ...
        {/* ══════════════════════════════════════════════
            2. PROBLEM — what small businesses deal with
        ══════════════════════════════════════════════ */}
        ...
        <div className="about-solution" id="services">
          <div className="about-solution-inner">
            <div className="about-solution-header">
              <span className="about-section-kicker">The solution</span>
              <h2 className="about-solution-title">
                One platform. Three verticals.<br />
                Built for real businesses.
              </h2>
              <p className="about-solution-sub">
                Time8out starts with employee time tracking and is expanding into
                gym memberships and ESL scheduling — all under one roof, all built
                with the same simplicity-first philosophy.
              </p>
            </div>
            ...
            <div className="about-pillars">
              {PILLARS.map((p) => (
                ...
                >
                  {p.soon && (
                    <span
                      className="about-pillar-badge"
                      style={{ background: p.border, color: p.color }}
                    >
                      Coming soon
                    </span>
                  )}
                  {!p.soon && (
                    <span
                      className="about-pillar-badge"
                      style={{ background: "rgba(233,82,14,0.15)", color: "var(--brand-orange-dark)" }}
                    >
                      Live now
                    </span>
                  )}
          ...
          <div className="about-mission-inner">
            ...
            <div className="about-mission-copy">
              ...
              <p className="about-mission-body">
                ...
                <strong> small businesses, ESL schools, and gyms</strong> the same
                professional-grade time management that big companies take for granted —
                at a price that actually makes sense.
              </p>
              <p className="about-mission-body">
                This is a product built <strong> for businesses
             </strong> where hardworking owners deserve better tools.
              </p>
            </div>
